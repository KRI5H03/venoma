    ...
    <section className="mt-24 pt-[72px] min-h-[540px] bg-[url(/assets/img/benefits/bg.png)] bg-no-repeat bg-cover relative overflow-hidden">
      <div className="container mx-auto flex flex-col">
          ...
          <div className="flex-1 flex flex-col gap-6 w-full max-w-[360px]">
            <div>
              ...
              <p className="xl:text-right">
                Designed to withstand the rigors of active lifestyle, ensure
                longevity.
              </p>
            </div>
            <div>
              ...
              <p className="xl:text-right xl:max-w-[290px] xl:ml-auto">
                Explore a diverse range of products tailored to meet the needs
                of every athlete
              </p>
            </div>
          </div>
        ...
        <div className="w-full h-[280px] xl:h-auto xl:absolute top-0 bottom-0 right-0 left-0">
          {/* logo bg */}
          <div className="w-full h-full bg-[url('/assets/img/benefits/logo.png')] bg-bottom bg-no-repeat absolute -bottom-56">
            logo
          </div>
